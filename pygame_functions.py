# pygame_functions
# This has been downloaded to make pygame easier, it basically has methods i may have missed in my game..
# To avoid any errors and the game running smoothly
...
def touching(player, cloud):
    collided = pygame.sprite.collide_mask(player, cloud)
    return collided
